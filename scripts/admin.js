...
async function carregarPostagens() {
    ...
    snap.forEach((docSnap) => {
        ...
        div.innerHTML = `
            <h3>${dados.titulo}</h3>
            <p class="conteudo-limitado">${dados.conteudo}</p>
            ${dados.imagemURL ? `<img src="${dados.imagemURL}" alt="Imagem do projeto" />` : ""}
    ...
    listaContainer.querySelectorAll(".toggle").forEach((btn) => {
